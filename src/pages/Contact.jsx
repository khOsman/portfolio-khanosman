...
const Contact = () => {
    ...
    return (
        <div>
            <Navbar></Navbar>
            <div className='flex lg:flex-row flex-col justify-center gap-8 items-center my-5 mx-auto w-5/2 p-8 text-white'>
                ...
                <div className='lex flex-col justify-center items-center'>
                    ...
                    <form ref={form} onSubmit={handleSubmit(onSubmit)} className="card-body">
                        <div className="form-control">
                            ...
                            <input type="text" className="input input-bordered input-success w-full max-w-xs mb-1" {...register('name', { required: true })} placeholder="Name" />
                        ...
                        <div className="form-control">
                            ...
                            <input type="email" className="input input-bordered input-success w-full max-w-xs mb-1" {...register('email', { required: true })} placeholder="Email" />
